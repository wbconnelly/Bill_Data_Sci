...
# read in the list of company symbold from the S&P 500
...
# Pull down yearly financial reporting data from the Kimono SEC API
...
# I need a more systematic way of selecting features 
# and a better way of dealing with missing values
